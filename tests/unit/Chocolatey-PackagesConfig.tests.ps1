...
Describe "When calling Chocolatey-PackagesConfig with a packages.config manifest that has installArguments" {
...
Describe "When calling Chocolatey-PackagesConfig with a packages.config manifest that has no installArguments attribute" {
